...
namespace RGPopup.Maui.Windows.Renders
{
    public class PopupPageRenderer : ContentPanel
    {
        ...
        public PopupPageRenderer(PopupPageHandlerWindows handler)
        {
        ...
        internal void Prepare(WinPopup container, Window window)
        {
            Container = container;
            Window = window;
            UpdateElementSize();
        ...
        public void UpdateElementSize()
        {
            if (CurrentElement != null && Window != null)
            {
                ...
                var systemPadding = new Microsoft.Maui.Thickness(left, top, right, bottom);
